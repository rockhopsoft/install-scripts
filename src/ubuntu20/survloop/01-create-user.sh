...
echo '=================================='
echo 'Ubuntu 20.04 Super User Initiation'
echo '----------------------------------'
...
echo ''
read -p $'What fixed IP address will you connect from for this server? This could be your super user\'s VPN or home router IP.\n(e.g. 123.456.789.012)\n' IP
echo ''
